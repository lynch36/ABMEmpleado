...
export class AddEditEmpleadoComponent implements OnInit {
  estadosCiviles: any[] = ['Soltero', 'Casado'];
  myForm: FormGroup;
  idEmpleado: any;
  accion = 'Crear';
  ...
  constructor(private fb: FormBuilder, private empleadoService: EmpleadoService,
    ...
    const idParam = 'id'
    this.idEmpleado = aRoute.snapshot.params[idParam];
  }
  ...
  agregarEmpleado(empleado: Empleado) {
    ...
    this.snackBar.open('El empleado fue agregado', '', {
      duration: 3000
    });
    this.route.navigate(['/']);
  }
  ...
  editarEmpleado(empleado: Empleado) {
    ...
    this.snackBar.open('El empleado fue editado', '', {
      duration: 3000
    });
    this.route.navigate(['/']);
  }
